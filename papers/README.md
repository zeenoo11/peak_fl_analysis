...
│   └── figures/         # F0..F6 PNGs
├── v02_draft/           # placeholder, v02 in progress
...
| **v02** | FL-aligned 80:20 zero-shot under PFL framing | `plans/v02-01_fl_8020_ratio.md` | `experiments/v02_fl_8020_ratio/` | `outputs/v02_fl_8020_ratio/` | scaffolding |
...
- Each new version increments the major number when the *evaluation
  protocol or framing* changes (50:50 → 80:20 PFL → K-shot PFL).
- Method components frozen across v02/v03: NBEATSx + peak_aux head + W5
  hybrid correction. What changes is split, framing, and cold-side
  adaptation.
