...
Output: ``outputs/v06_round_dynamics/figures/F6_codebook_lift.png``.
...
def main() -> None:
    ...
    ap.add_argument("--summary_path", type=Path, default=None,
                    help="Override path to codebook_lift_summary.json (default: "
                         "outputs/v06_round_dynamics/codebook_lift_summary.json).")
    ap.add_argument("--fig_dir", type=Path, default=None,
                    help="Override output directory (default: "
                         "outputs/v06_round_dynamics/figures/).")
    args = ap.parse_args()

    summary_path = args.summary_path or (
        OUTPUT_DIR / "v06_round_dynamics" / "codebook_lift_summary.json"
    )
    ...
    if not summary_path.exists():
        raise FileNotFoundError(
            ...
            f"experiments/v06_round_dynamics/09_aggregate_codebook.py first."
        )
