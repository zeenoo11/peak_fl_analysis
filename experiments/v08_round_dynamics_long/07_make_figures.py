...
def main() -> None:
    ...
    ap.add_argument("--traj_path", type=Path, default=None,
                    help="Override path to trajectories.npz (default: outputs/v08_round_dynamics_long/trajectories.npz).")
    ...
    traj_path = args.traj_path or (OUTPUT_DIR / "v08_round_dynamics_long" / "trajectories.npz")
